...
REM
REM Generated by Vivado on Sun Feb 08 23:41:06 +0700 2026
...
echo "xvlog --incr --relax -prj branch_predictor_tb_vlog.prj"
call xvlog  --incr --relax -prj branch_predictor_tb_vlog.prj -log xvlog.log
